...
<div class="container">
     <div class="x_panel">
            <div class="x_title">
                <h2>
                    Lista de Pacientes Internados com MDR</h2>
                <div class="clearfix">
                </div>
            </div>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="cd_prontuario"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="nm_unidade_funcional" HeaderText="UNIDADE FUNCIONAL" SortExpression="nm_especialidade"
                     HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" />
                       <asp:BoundField DataField="mdr" HeaderText="SITUAÇÃO" HeaderStyle-CssClass="visible-lg" ItemStyle-CssClass="visible-lg" >
